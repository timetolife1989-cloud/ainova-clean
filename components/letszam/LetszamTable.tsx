...
export default function LetszamTable({
  ...
  const handleKeyDown = (e: KeyboardEvent<HTMLInputElement>, index: number) => {
    // Tab navigation only on "Megjelent" column
  ...
  return (
    <div className="mb-8">
      ...
      <div className="overflow-x-auto">
        <table className="w-full bg-slate-900/95 border border-slate-700 rounded-lg overflow-hidden">
          <thead>
                ...
                >
                  <td className="px-4 py-3 text-sm text-white font-medium">
                    <div className="flex items-center gap-2">
                      {row.pozicio}
                      {critical && (
                        <span className="text-xs px-2 py-1 bg-yellow-900/30 text-yellow-400 rounded border border-yellow-700/50">
                          ⚠️ KRITIKUS
                        </span>
                      )}
                    </div>
                  ...
                  <td className="px-4 py-3 text-center">
                    <input
                      ...
                      className="
                        w-20 px-3 py-2 text-center bg-slate-800 text-white rounded
                  ...
                  <td className="px-4 py-3 text-center text-sm font-semibold">
                    <span className={`
                      ${row.hianyzasPercent > 0 ? 'text-red-400' : 'text-slate-500'}
                    `}>
